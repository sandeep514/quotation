...
namespace CoreSolutions\CoreAdmin\Commands;

use App\User;
use Illuminate\Console\Command;
use CoreSolutions\CoreAdmin\Models\Menu;
use CoreSolutions\CoreAdmin\Models\Role;

class CoreAdminInstall extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'coreadmin:install';
     ...
     * @var string
     */
    protected $description = 'Run installation of CoreAdmin.';
    ...
    {
        $this->info('Please note: CoreAdmin requires fresh Laravel installation!');
        $this->info('Starting installation process of CoreAdmin...');
