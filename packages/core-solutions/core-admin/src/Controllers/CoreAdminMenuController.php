...
use CoreSolutions\CoreAdmin\Builders\ControllerBuilder;
use CoreSolutions\CoreAdmin\Builders\MigrationBuilder;
use CoreSolutions\CoreAdmin\Builders\ModelBuilder;
use CoreSolutions\CoreAdmin\Builders\RequestBuilder;
use CoreSolutions\CoreAdmin\Builders\ViewsBuilder;
use CoreSolutions\CoreAdmin\Cache\QuickCache;
use CoreSolutions\CoreAdmin\Fields\FieldsDescriber;
use CoreSolutions\CoreAdmin\Models\Menu;

class CoreAdminMenuController extends Controller
{
...
//        dd($fields);
        ...
        return redirect(config('coreadmin.route'));
    }
