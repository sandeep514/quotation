...
<body>
	<div class="container">
		<div class="">
			<div class="">
				<img src="{{ asset('abstract-dotted-banner-background_1035-18160.jpg') }}" style="width: 100%">
			</div>
			<div>
			...
			<div>
				<div style="border: 2px solid #000">
					<div style="float: left;border-right: 2px solid #000">
						<ul>
					...
					<div style="">
						<ul>
							<li style="list-style: none">
								<h4 style="margin: 17px;list-style: none;text-align: center;font-size: 26px">Rs 111111111</h4>
							</li>
							<li style="list-style: none">
								<p style="list-style: none;text-align: center;">frjrhegiergreg reg rgre gerger</p>
							</li>
						</ul>
					</div>
				</div>
