...
{!! Form::open(array('files' => true, 'route' => config('coreadmin.route').'.items.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('technical_spec', old('technical_spec'), array('class'=>'form-control ckeditor')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('other_terms', old('other_terms'), array('class'=>'form-control ckeditor')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('commercial_terms_condition', old('commercial_terms_condition'), array('class'=>'form-control ckeditor')) !!}
